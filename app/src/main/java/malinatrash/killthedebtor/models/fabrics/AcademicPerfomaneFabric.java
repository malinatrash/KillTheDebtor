...
public class AcademicPerfomaneFabric {
    public static AcademicPerfomaneFabric shared = new AcademicPerfomaneFabric();

    public AcademicPerfomaneFabric() {
    }

    public ArrayList<AcademicPerformance> getAcademicPerfomancesFor_pavel_istb_21_1() {
        return new ArrayList<>(Arrays.asList(
                new AcademicPerformance(
